...
#define FN_LAYER(change_default_to) LAYOUT_60_tsangan_hhkb( \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, MO(4),   \
    ...
    _______, _______, _______,                                     _______,                                     _______, DF(change_default_to),   _______ \
  ),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_60_tsangan_hhkb(
    ...
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, TT(3),
    _______, KC_LGUI, KC_LALT,                                     KC_SPC,                                      KC_RALT, KC_RGUI, _______
  ),
  [3] = FN_LAYER(0)
